...
const url = 'http://dynamics.sandisk.com/Dynamics/_root/homepage.aspx?etc=10173&pagemode=iframe&sitemappath=TEST%7cExtensions%7czsd_screquest';
...
var repeater = setInterval(() => get_TCR_UID(), 3*60*1000);
get_TCR_UID();
